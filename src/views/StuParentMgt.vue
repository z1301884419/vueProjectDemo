<template>
  <div class="stu-parent-info">
    ...
    <!--学生的页面-->
    <div v-if="shenfen=='家长'" class="this-stu-parent-info">
      <div class="left">
        <div>
    ...
    <!--班主任的页面-->
    <div v-if="shenfen=='班主任'||shenfen=='管理员'">
...
<style>
  ...
  .stu-parent-info input{
    font-family: kaola;
  }
  .stu-parent-info button{
    font-family: kaola;
  }
  .el-main{
