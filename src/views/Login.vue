  ...
  <div class="home">
    ...
    <div class="loginWindow">
      ...
      <div class="loginBox">
        ...
        <el-form ref="form" :model="form" label-width="80px" :rules="rules">
          ...
          <el-row style="margin-top: 30px" class="aaaa1">
            <el-button
              plain
              style="width: 80px; margin-left: 90px; float: left"
              @click="subMitfn"
              >登录</el-button
            >
            <el-button
      ...
      <el-dialog
        ...
        style="width: 1500px; margin-left: 40px"
      >
        <el-form :model="form1" ref="form1" class="bb">
          ...
          >
            <el-input
              class="yanzheng"
              v-model="form1.vertifyCode"
              autocomplete="off"
              style="width: 200px"
            ></el-input>
            <el-button @click="huoQu()" plain class="plainBtn"
              >获取验证码</el-button
            >
          </el-form-item>
          <el-form-item
        ...
        .then((response) => {
          ...
          if (response.data.code != 200) {
            ...
            sessionStorage.setItem(
              "username",
              JSON.stringify(this.form.zhangHao)
            );
